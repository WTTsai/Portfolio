...
<?php
	...
	$assignment0 = new Assignment("Assignment2.0", "svn_log.xml", "svn_list.xml");
	$assignment1 = new Assignment("Assignment2.1", "svn_log.xml", "svn_list.xml");
	    ...
	    if($comm["parent"] == $parentID)
	    {
	      ...
	      if($parent == -1){
		      ...
		      $comment<br />
		       ...
		       echo "<form action='Assignment2.php#comments' id = 'myform' method='post'>";
		       ...
		       echo "<input type= 'hidden' name='pageID' value = '2'>";	
...
<body>
	...
	<section id="main" class="wrapper">
		...
		echo "Summary: ".$assignment0->summary;
		?>
	</header>
		</div>
	</section>
<!-- Table -->
	...
	<section id="main" class="wrapper">
		...
		echo "Summary: ".$assignment1->summary;
		?>
	</header>
		</div>
	</section>
<!-- Table -->
	...
	<section>
		...
		<?php
		  ...
		  $query = "SELECT * FROM  `Comments` WHERE `pageID` = 2 LIMIT 0 , 30";
