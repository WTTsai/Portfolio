	    ...
	    if($comm["parent"] == $parentID)
	    {
	      ...
	      if($parent == -1){
		      ...
		      $comment<br />
		       ...
		       echo "<form action='Assignment0.php#comments' id = 'myform' method='post'>";
		       ...
		       echo "<input type= 'hidden' name='pageID' value = '0'>";	
...
<body>
	...
	<section id="main" class="wrapper">
		...
		<?php
		echo "Name: ".$assignment->title."<br/>";
		echo "Date: ".$assignment->date."<br/>";
		echo "Version: ".$assignment->version."<br/>";
		echo "Summary: ".$assignment->summary."<br/>";
		?>
	</header>
		</div>
	</section>
<!-- Table -->
		...
		<div class="table-wrapper">
			<table>
				...
				<tbody>
						...
						<?php
						foreach($assignment->fileList as $f){
	...
	<section>
		...
		<?php
		  ...
		  $query = "SELECT * FROM  `Comments` WHERE `pageID` = 0 LIMIT 0 , 30";
